...
The keys live in `.claude/settings.json` (project) or `/home/madargani/Work/tries/2026-07-07-ai-language-partner/.opencode/settings.json` (global) — **not** in `.planning/config.json`:
