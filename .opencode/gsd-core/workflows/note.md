...
- **Global scope**: `/home/madargani/Work/tries/2026-07-07-ai-language-partner/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/madargani/Work/tries/2026-07-07-ai-language-partner/.opencode/notes/`)
...
2. Glob `/home/madargani/Work/tries/2026-07-07-ai-language-partner/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/madargani/Work/tries/2026-07-07-ai-language-partner/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/madargani/Work/tries/2026-07-07-ai-language-partner/.opencode/notes/` — works in any directory
