...
```
Agent(
  prompt="Read /home/madargani/Work/tries/2026-07-07-ai-language-partner/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/madargani/Work/tries/2026-07-07-ai-language-partner/.opencode/gsd-core/templates/SECURITY.md`
