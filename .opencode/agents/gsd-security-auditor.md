...
**Verification depth scales with `asvs_level`** (see @/home/madargani/Work/tries/2026-07-07-ai-language-partner/.opencode/gsd-core/references/security-asvs-levels.md for full definitions):
